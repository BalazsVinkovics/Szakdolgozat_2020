...
for emb in dataset.iloc():
        ...
        if emb[129] == 0:
            emb.append(prediction_female)
        if emb[129] == 1:
            emb.append(prediction_male)
...
history = model.fit(X_train_emb, Y_train_label, epochs=50, validation_split=0.2, steps_per_epoch=2)
...
# model.save("D:/Szakdolgozat/Neural_Networks_sex/DNN_race")

#Plot results
plt.plot(history.history['accuracy'])
plt.plot(history.history['val_accuracy'])
plt.title('A nem modell pontossága')
